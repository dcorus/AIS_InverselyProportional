...
\begin{table*}[t!]
	\caption{Expected runtimes of the different mutation operators when embedded in a (1+1) algorithmic framework for the benchmark functions considered in this paper. For all results the optimum is unknown to the algorithms. \rev{The $*$ indicates that we have not performed a formal analysis, yet for reasons provided at the end of Section~\ref{sec:ltj}, the upper bound is correct.} 

...
%%% FIX 2 — clarify f_OPT non-negativity and meaning
 The original inversely proportional hypermutation operator (\IPHfcm{}) proposed for Opt-IA uses mutation potential  $M=\lceil(1-f_{\text{OPT}}/v)\rceil cn$ for minimisation problems, where \textcolor{blue}{$f_{\text{OPT}}\ge 0$ is the optimal fitness value, $v>0$ is the fitness of the current individual,} 

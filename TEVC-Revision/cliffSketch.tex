...
all supporting lemmata.  All proofs are deferred to the supplementary materials. 
%the 
...
algorithm into a configuration with \textcolor{black}{$n-d+2$ 1-bits i.e., ($r_0=2$) and the minimal Hamming distance of $HD(r_0)=2$ to the $best$ solution which had $n+d$ 1-bits.}  The following lemma formalises this.

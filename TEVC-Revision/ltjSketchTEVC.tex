...
\begin{proof}
	Let $T:=n^2$. \textcolor{purple}{We will show that in $T$ iterations with high probability we sample a solution from  $J$ before we sample one from $\mathcal{B}_k$ or $\mathcal{D}_\rho$.}

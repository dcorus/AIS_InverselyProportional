...
Formally, for constants $k\ge1$ and $\rho\in(0.8,0.9)$, let $r := 2k+1$\textcolor{blue}{
(an odd number, as required for the block-jump prefix $0^r1^{(0.9n-r)}*$
...
$p_D$ respectively), the expected number of epochs until both have been seen
is $O(1/p_B + 1/p_D)$.}

...
algorithm into a configuration \textcolor{purple}{two extra 1-bits and u}with low Hamming distance to the locked 
...
envelope suitable for applying \textcolor{purple}{Ville's inequality for non-negative supermartingales (where is it?)}.
...
To guarantee the \textcolor{purple}{drift negativity} required above, we identify the admissible 

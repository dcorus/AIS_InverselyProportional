...
\begin{lemma} 
	...
	Then, with probability $\new{p_B}=\Omega(\min\{1,\,\tau\,n^{-(2k+2)}\})$, the epoch performs a jump placing the individual in $\mathcal{B}_k$.
\end{lemma}
...
%\end{lemma}
\begin{lemma} 
	Let an ageing epoch begin at the junction \textcolor{purple}{and let $c <5/8$}.
	Then, with probability $\new{p_D}=\Omega(\min\{1,\,\tau\,n^{-\beta}\})$ where $\beta:=\log_2 \frac{20}{c}$, the epoch performs a jump placing the individual in $\mathcal{D}_\rho$.
\end{lemma}

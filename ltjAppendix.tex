...
\begin{proof}
	...
	\(
	M\ge c\,\tfrac{n}{20} \geq n/60 \geq r+1.
	\)
...
\begin{lemma} \label{lem:DPO-epoch}
	Let an ageing epoch begin at the junction \textcolor{purple}{and let $c <1/3$}.
...
\begin{proof}[Proof of Lemma \ref{lem:DPO-epoch} (revised)]
	...
	(owing to the uniform suffix). We condition on this event, so we have
	 \(M\ge n/60\) throughout the epoch.
	...
	\(L\) leading ones to from $1$ to $0$ before FCM stops.

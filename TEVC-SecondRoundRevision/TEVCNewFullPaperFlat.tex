...
\begin{lemma}\label{lem:buffer}
	...
	E_r=\sum_{j=r_0+1}^{r} Y_{z_j}\rerev{\quad\text{($Y_{z_j}$ as in Lemma~\ref{lem:phase-mgf} at zero-bit count $z_j$)}},
	\]

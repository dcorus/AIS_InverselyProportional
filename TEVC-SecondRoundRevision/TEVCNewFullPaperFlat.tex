...
\begin{proof}
	...
	\rerev{\begin{equation}\label{eq:zero-flip-bound}}
...
\textcolor{black}{Each \emph{ageing epoch} begins with a uniformly random reinitialisation and
...
By Lemma~\ref{lem:junction-first-density-Bk} we reach the junction $J$ with probability \ \(1-o(1)\).
	Starting an epoch in the junction, \rerev{Lemma \ref{lem:BJO-epoch}  and Lemma \ref{lem:DPO-epoch} respectively} give

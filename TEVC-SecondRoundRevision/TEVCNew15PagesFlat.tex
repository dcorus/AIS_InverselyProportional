...
\rerev{Thus, the operator can be considered as a compromise between always updating the best seen and never updating the best seen when a new solution of equal fitness to the current best is encountered.}  

...
either the next improvement occurs (reducing to $z-1$ zeros) or a
catastrophic return to the cliff-top.
...
Recall $\mathcal{B}_k = \{0^r 1^{(0.9n-r)}*\}$ with $r = 2k+1$.

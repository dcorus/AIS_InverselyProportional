...
\begin{lemma}\label{lem:xi-tail}
	\textcolor{black}{Let the current solution on the second slope have $z\le d$ zero-bits and
	define $p=z/n$.
...
\begin{proof}[Proof [Theorem~\ref{th:expoHD-cliff}]]
	...
	\]
	iterations, which is $o(\tau)$ since $\tau=\Omega(n^{1+\epsilon'})$. \textcolor{black}{Since the mutation potential satisfies $M \le c\,n$ (where $c$ is the constant
